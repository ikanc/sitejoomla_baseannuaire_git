...
//		}
	...
	function _processMapv3_markers() {
		...
		if ($this->_mp->description!=''||$this->_mp->dir!='0') {
			if ($this->_mp->dir!='0')
				$dirform =""; //LGW : $this->_processMapv3_templatedirform('Marker');
			else
				$dirform = "";
	...
	function _processMapv3_templatedirform($type) {
		...
		//LGW: ajout span / radio pour CSS
		if ($this->_mp->txt_driving!=''||$this->_mp->dirtype=="D")
			$dirform.="<span class='dirflg-driven'><input ".(($this->_mp->txt_driving=='')?"type='hidden' ":"type='radio' ")."class='radio' name='dirflg' value='' ".(($this->_mp->dirtype=="D")?"checked='checked'":"")." />".$this->_mp->txt_driving.(($this->_mp->txt_driving!='')?"&nbsp;":"")."</span>";
		if ($this->_mp->txt_avhighways!=''||$this->_mp->dirtype=="1")
			$dirform.="<span class='dirflg-nohighways'><input ".(($this->_mp->txt_avhighways=='')?"type='hidden' ":"type='radio' ")."class='radio' name='dirflg' value='h' ".(($this->_mp->avoidhighways=='1')?"checked='checked'":"")." />".$this->_mp->txt_avhighways.(($this->_mp->txt_avhighways!='')?"&nbsp;":"")."</span>";
		if ($this->_mp->txt_transit!=''||$this->_mp->dirtype=="R")
			$dirform.="<span class='dirflg-transit'><input ".(($this->_mp->txt_transit=='')?"type='hidden' ":"type='radio' ")."class='radio' name='dirflg' value='r' ".(($this->_mp->dirtype=="R")?"checked='checked'":"")." />".$this->_mp->txt_transit.(($this->_mp->txt_transit!='')?"&nbsp;":"")."</span>";
		if ($this->_mp->txt_bicycle!=''||$this->_mp->dirtype=="B")
			$dirform.="<span class='dirflg-bicycle'><input ".(($this->_mp->txt_bicycle=='')?"type='hidden' ":"type='radio' ")."class='radio' name='dirflg' value='b' ".(($this->_mp->dirtype=="B")?"checked='checked'":"")." />".$this->_mp->txt_bicycle.(($this->_mp->txt_bicycle!='')?"&nbsp;":"")."</span>";
		if ($this->_mp->txt_walking!=''||$this->_mp->dirtype=="W")
			$dirform.="<span class='dirflg-walking'><input ".(($this->_mp->txt_walking=='')?"type='hidden' ":"type='radio' ")."class='radio' name='dirflg' value='w' ".(($this->_mp->dirtype=="W")?"checked='checked'":"")." />".$this->_mp->txt_walking.(($this->_mp->txt_walking!='')?"&nbsp;":"")."</span>";
