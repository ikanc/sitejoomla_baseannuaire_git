...
//LGW: ??? ne marche pas si on fait la selection depuis l'interc admin ?...
$jmapMarkerPointOpenHTMLEvent = 'mouseover'; //$params->get('$JmapMarkerPointOpenHTMLEvent', 'click');
...
//									console.log('Address - Lat = ' + latitude + ' Lng = ' + longitude + ' Address = ' + MapMarkerObject.attr('Address'));
									...
									jQuery(mapDiv).jmap('AddMarker',{
										...
										//LGW: on aouvre la bulle au survol seulement
